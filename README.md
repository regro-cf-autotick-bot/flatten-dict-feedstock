...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/flatten-dict-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10494&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/flatten-dict-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `flatten-dict` can be installed with:

```
conda install flatten-dict
```

It is possible to list all of the versions of `flatten-dict` available on your platform with:
